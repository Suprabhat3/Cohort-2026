...
- `<hr>`: Horizontal rule, used to visually separate content sections.
...
- `<span>`: Used to group inline elements and apply styling or attributes.
...
- `<div>`: Generic container for flow content, used for theme status.
